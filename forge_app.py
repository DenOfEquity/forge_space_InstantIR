# minor modifications by DenOfEquity:
#  to function as a Forge2 Space
#  use fp16 model
#  use sequential offloading - much faster with 8GB VRAM
#  option to not produce previews for each step (VAE per step)
...
#sdxl_repo_id = "SG161222/RealVisXL_V4.0"
...
def instantir_restore(
    ...
    creative_restoration=False, seed=3407, height=None, width=None, previews=False, preview_start=0.0):
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        with gr.Column():
            ...
            previews = gr.Checkbox(label="Save Previews for each Step", value=True)
    ...
    restore_btn.click(
        instantir_restore, inputs=[
            ...
            mode, seed, height, width, previews, preview_start
        ],
